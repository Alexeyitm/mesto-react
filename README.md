...
Проект Mesto - интерактивная страница, на которую можно добавлять фотографии, удалять их и ставить лайки. Кроме этого реализована сортировка добавленных карточек. Версия на React.
...
* Реализовать сортировку карточек ✅
